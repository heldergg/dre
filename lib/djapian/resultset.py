...
class ResultSet(object):
    def __init__(self, indexer, query_str, offset=0, limit=None,
                 ...
                 collapse_by=None, instances=False, stopper=None, parse_query = True):
    ...
    def _parse_results(self):
        ...
        for match in self._mset:
            ...
            self._resultset_cache.append(
                Hit(pk, docid, model, percent, rank, weight, tags, collapse_count, collapse_key)
            )
...
class Hit(object):
    def __init__(self, pk, docid, model, percent, rank, weight, tags, collapse_count, collapse_key):
        # Added the docid
        self.pk = pk
        self.docid = docid
        self.model = model

...
# App imports
from dreapp.models import (Document, DocumentText, DocumentCache,
                           NoIndexDocument)
...
INDEX_URL = ('https://dre.pt/web/guest/pesquisa-avancada/'
             '-/asearch/advanced/maximized?'
             'types=DR&dataPublicacao=%s&perPage=1000'
             )
...
SYNONYMS = [
    ...
    [u'decreto do presidente da república',
     u'decreto',
     u'decreto do representante da república para a região autónoma da '
     u'madeira'],
    [u'resolução',

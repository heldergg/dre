...
USER_SETTINGS = [
        { 'name'      : 'profile_public',
          ...
          'default'   : True,
          'type'      : 'boolean',
          'help_text' : '<div class="help_text">Determina a visibilidade dos marcadores, notas e etiquetas. <strong>ATENÇÃO</strong>, isto apenas se aplica a novos marcadores, notas e etiquetas.</div>',
        },
        { 'name'      : 'newsletter',
        ...
        { 'name'      : 'show_user_notes',
          ...
          'default'   : True,
          'type'      : 'boolean',
          'help_text' : '<div class="help_text">Quando visualiza um documento pode associar-lhe notas se tiver esta opção ligada.</div>',
        },
        { 'name'      : 'show_tips',
